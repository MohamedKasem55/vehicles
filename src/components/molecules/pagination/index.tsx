...
const btnStyle = { background: '#FFFFFF', border: '1px solid #E5E7EB', color: '#4B5563', fontFamily: 'Inter', fontWeight: 500, fontSize: '11.9px' }

function Pagination({ currentPage, totalItems, itemsPerPage, onPageChange }: IPagination) {
  ...
  return (
    <div
      ...
      style={{ background: 'rgba(249, 250, 251, 0.5)', borderTop: '1px solid #F3F4F6', borderRadius: '0 0 12px 12px' }}
      dir='rtl'
    >
      {/* Info text - right side in RTL */}
      <div className='flex flex-row items-center gap-1' style={{ fontFamily: 'Inter', fontSize: '11.9px', lineHeight: '20px' }}>
      ...
      <div className='flex flex-row items-center gap-1'>
        ...
        {pages.map((page) => (
          <button
            ...
            style={
              page === currentPage
                ? { background: '#348C68', boxShadow: '0px 1px 2px #99F6E4', color: '#FFFFFF', fontFamily: 'Inter', fontWeight: 500, fontSize: '11.9px' }
                : btnStyle
            }
          >
            {page}
