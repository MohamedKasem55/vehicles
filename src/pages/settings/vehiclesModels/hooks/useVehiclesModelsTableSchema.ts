...
function useVehicleModelsTableSchema(): IColumnSchema[] {
  ...
  return useMemo<IColumnSchema[]>(() => [
    { key: 'vehicleModel', label: 'طراز المركبة',    type: 'text' },
    { key: 'vehicleName', label: 'اسم المركبة', type: 'text' },
...
export default useVehicleModelsTableSchema;
