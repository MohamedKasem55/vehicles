...
function useVehicleCompaniesTableSchema(): IColumnSchema[] {
  ...
  return useMemo<IColumnSchema[]>(() => [
    { key: 'vehicleArName', label: 'اسم المركبه بالعربي',    type: 'text' },
    { key: 'vehicleEnName', label: 'اسم المركبه بالانجليزي', type: 'text' },
...
export default useVehicleCompaniesTableSchema;
